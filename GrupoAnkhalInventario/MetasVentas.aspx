<%@ Page Title="Metas de Ventas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MetasVentas.aspx.cs" Inherits="GrupoAnkhalInventario.MetasVentas" %>
...
<div class="col-12">
    ...
    <div class="stock-dashboard">
        ...
        <div class="stock-card producido">
            ...
            <div class="info">
                <div class="num"><asp:Label ID="lblValorVendido" runat="server" Text="$0.00"></asp:Label></div>
                <div class="lbl">Valor Vendido del Per&iacute;odo</div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                ...
                Cumplimiento de metas de ventas por base
            </h3>
